    ...
    return h(
      ...
      [h('colgroup', [this.table.tableColumns.map(function (column) {
        ...
        [h(
          ...
          [renderCustomRow.call(this, {}, -1, $table.tmpData['$firstdata'])]
        )]
        ...
        return [h(
          ...
          [h(
            ...
            [renderCustomRow.call(_this2, row, rowIndex, $table.tmpData[row[$idProp]])]
          )]
        )])];
      }) : h(
        'tr',
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_object_assign__ = __webpack_require__(25);
...
function initialState(table, expandKey) {
  ...
  var _getBodyData = getBodyData(table.data, table.treeType, table.childrenProp, table.idProp, table.manualFoldStatus, table.manualFoldStatus, table.foldStatus, table.version),
